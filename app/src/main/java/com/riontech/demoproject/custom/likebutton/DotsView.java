...
public class DotsView extends View {
    ...
    private static final int COLOR_1 = 0xFF303F9F; //FF5722
    private static final int COLOR_2 = 0xFF303F9F; //FFAB91
    private static final int COLOR_3 = 0xFF303F9F; //FF5722
    private static final int COLOR_4 = 0xFF303F9F; //FFAB91
    ...
    private void updateInnerDotsPosition() {
        if (currentProgress < 0.3f) {
            this.currentRadius2 = (float) mapValueFromRangeToRange(currentProgress, 0, 0.3f, 0.f, maxInnerDotsRadius);
        } else {
        ...
        if (currentProgress < 0.2) {
            ...
            this.currentDotSize2 = (float) mapValueFromRangeToRange(currentProgress, 0.2f, 0.5f, maxDotSize, 0.3 * maxDotSize);
        } else {
            this.currentDotSize2 = (float) mapValueFromRangeToRange(currentProgress, 0.5f, 1f, maxDotSize * 0.3f, 0);
        }
