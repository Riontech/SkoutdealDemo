package com.riontech.demoproject.custom;
...
public class StaggeredTextGridView extends ScrollView {
    ...
    private void generateSpannableTextGridView() {
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            LinearLayout textView = (LinearLayout) mAdapter.getView(i, null, this);
            ...
            if (i % 3 == 0) {
                Log.e("TAG", "Padding111 = " + padding);
                Log.e("TAG", "Device111 = " + mDeviceWidth);

                itemWidth = mDeviceWidth + padding;
                Log.e("TAG", "Width111 = " + itemWidth);
                RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(itemWidth, RelativeLayout.LayoutParams.WRAP_CONTENT);
                textView.setLayoutParams(params);
            } else {
                Log.e("TAG", "Padding222 = " + padding);
                Log.e("TAG", "Device222 = " + mDeviceWidth);
                itemWidth = (mDeviceWidth / 2) + padding;

                Log.e("TAG", "Width222 = " + itemWidth);
